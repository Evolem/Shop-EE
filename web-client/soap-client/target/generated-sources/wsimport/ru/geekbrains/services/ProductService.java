 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://services.geekbrains.ru/", wsdlLocation = "http://localhost:8080/JspWebApp/ProductService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://services.geekbrains.ru/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JspWebApp/ProductService?wsdl");
    ...
    public ProductServiceWs getProductServicePort() {
        return super.getPort(new QName("http://services.geekbrains.ru/", "ProductServicePort"), ProductServiceWs.class);
    }
    ...
    public ProductServiceWs getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.geekbrains.ru/", "ProductServicePort"), ProductServiceWs.class, features);
    }
